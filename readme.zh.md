...
<h4 align="right">查看其他語言</h4>
<p align="right"><a href="readme.md">🇬🇧</a> <a href="readme.de.md">🇩🇪</a> <a href="readme.it.md">🇮🇹</a> <a href="readme.fr.md">🇫🇷</a> <a href="readme.es.md">🇪🇸</a> <a href="readme.ja.md">🇯🇵</a> <a href="readme.ko.md">🇰🇷</a> <a href="readme.hi.md">🇮🇳</a> <a href="readme.de-DE-BA.md">🏴󠁤󠁥󠁢󠁹󠁿</a></p>
...
- 🧑‍💼 **志工工作**:
  - 🧭 [Coburg Jusos 副主席](https://www.instagram.com/jusos_coburg/)
...
#### NEU
此頁面現在支援多種語言。您可以在右上角選擇語言。

此外，頁面新增了更多資訊，並在專案概覽上方顯示新專案。

### 🔏 KeePass 外掛程式集合 ([查看倉庫](https://github.com/Hirschfuchs/keepass-plugins))

> 個人收集的實用 KeePass 外掛程式，與大家分享，並提供自動更新。

#### NEU
在使用 KeePass 資料庫時，我注意到 KeePass 主程式可以透過套件管理工具更新，但外掛程式需要手動維護。於是我想到將外掛程式移到一個獨立的資料夾，這樣我就可以在不同設備間使用相同的外掛程式。

然後我又想：既然如此，不如將它放到 GitHub 上，這樣我可以隨時訪問，也可以與其他人分享，或許有人會覺得有用。

接著，我陷入了典型的程式設計師症候群：*「如果將外掛程式做成機器可讀並自動下載，那就可以用 Renovate 來維護了。」*

於是，這個專案就誕生了。目前進度大約 80%，我對結果很滿意。:)
...
- 🚨 緊急應用: 用於快速訪問緊急電話和相關資訊的 Web 應用程式
- 🚆 Deutschlandticket 規劃器: 計算使用 Deutschlandticket 在設定的最大旅行時間內可行的火車路線
- 🤓 Gitmoji 更新日誌產生器: 基於 Gitmoji 而不是關鍵字的更新日誌產生器分支專案
- 👣 Wikipedia Poker: 一個遊戲，目標是在兩個 Wikipedia 條目之間找到最短路徑（類似於 'Six Degrees of Wikipedia'）
- 🕎 Ilmenau 紀念石概覽: Ilmenau 城市中 Stolpersteine（絆腳石紀念碑）的概覽
- 🎲 GameFrame: 一個在瀏覽器中運行的桌遊模擬器。大學專案，目前不再維護或繼續開發。
此外，超過 300 個相關的 JIRA 任務及所有關聯資源已被刪除。
現在最好使用 BoardGameArena，他們已經實現了我最初的願景 :)
## 📚 主題
