...
<h3 align="right">다른 언어로 보기</h3>
<p align="right"><a href="readme.md">🇬🇧</a> <a href="readme.de.md">🇩🇪</a> <a href="readme.it.md">🇮🇹</a> <a href="readme.fr.md">🇫🇷</a> <a href="readme.es.md">🇪🇸</a> <a href="readme.zh.md">🇹🇼</a> <a href="readme.ja.md">🇯🇵</a> <a href="readme.hi.md">🇮🇳</a> <a href="readme.de-ba.md">🏴󠁤󠁥󠁢󠁹󠁿</a></p>
...
### 🏠 GitHub 시작 페이지 ([리포지토리 보기](https://github.com/Hirschfuchs/Hirschfuchs)) --> ([온라인으로 보기](https://github.com/Hirschfuchs/Hirschfuchs/blob/main/readme.md))

> 이 페이지 (GitHub 포트폴리오를 동적으로 생성하기 위한 프로젝트)

#### NEU
이 페이지는 이제 다국어를 지원합니다. 오른쪽 상단에서 언어를 선택할 수 있습니다.

또한 추가 정보가 업데이트되었으며, 프로젝트 개요 위에 새 프로젝트가 표시됩니다.

### 🔏 KeePass 플러그인 모음 ([리포지토리 보기](https://github.com/Hirschfuchs/keepass-plugins))

> 유용한 KeePass 플러그인의 개인 모음집, 공개 공유 및 자동 업데이트 지원.

#### NEU
KeePass 데이터베이스를 사용하면서 본체는 패키지 매니저를 통해 업데이트되지만, 플러그인은 수동으로 관리해야 한다는 점을 발견했습니다.

그래서 플러그인을 별도의 폴더로 옮겨 여러 기기에서 동일한 플러그인을 사용할 수 있도록 했습니다.

그리고 생각했습니다. '어차피 이렇게 할 거라면, GitHub에 올려서 어디서든 접근 가능하게 하고, 필요할 수 있는 다른 사람들과도 공유하자!'

그다음 전형적인 개발자 증후군이 시작되었습니다: *“Renovate로 관리 가능하도록, 플러그인을 기계가 읽을 수 있는 형식으로 정리하고 자동 다운로드하면 되잖아!”*

이렇게 해서 이 프로젝트가 탄생했습니다. 현재 진행률은 약 80%이며, 결과에 매우 만족하고 있습니다. :)
