...
<h4 align="right">In anderen Sprachen anzeigen</h4>
<p align="right"><a href="readme.md">🇬🇧</a> <a href="readme.it.md">🇮🇹</a> <a href="readme.fr.md">🇫🇷</a> <a href="readme.es.md">🇪🇸</a> <a href="readme.zh.md">🇹🇼</a> <a href="readme.ja.md">🇯🇵</a> <a href="readme.ko.md">🇰🇷</a> <a href="readme.hi.md">🇮🇳</a> <a href="readme.de-DE-BA.md">🏴󠁤󠁥󠁢󠁹󠁿</a></p>
...
### 🖼️ API für Zufallsbilder ([Repository anzeigen](https://github.com/OpenFoxes/random-image-api))

> API, die nach bestimmten Vorgaben zufällige Bilder auswählen und liefern kann.

#### NEU!
Ein kleines Python-Script, das ich vor einiger Zeit schon für ein kleines privates Projekt geschrieben habe. Die API könnte durchaus für den einen oder anderen Usecase ganz praktisch sein. Ich habe sie daher auf Github hochgeladen und werde sie in unregelmäßigen Abständen um neue Funktionen erweitern und Fehler beheben.

### 🎦 Tiny4Linux ([Repository anzeigen](https://github.com/OpenFoxes/Tiny4Linux))

> GUI-Controller zur Steuerung der OBSBOT Tiny Serie auf Linux-Systemen
...
- 🖼️ API für Zufallsbilder: API, die nach bestimmten Vorgaben zufällige Bilder auswählen und liefern kann.
- 📖 Portfolio: Eigenwerbung ^^
- ⌨️ Vim-Cheatsheet (Vimfo): Ein interaktives Cheatsheet für VIM-Tastenbelegungen
- 🏗️ TS-Builder: Implementierung eines dynamischen Builder Patterns in Typescript
- 🚨 Notfallapp: Web-Applikation für einen schnellen Zugang zu Notfallnummern und relevanten Informationen
- 🚆 Deutschlandticket-Planer: Berechnung der verfügbaren Zugverbindungen mit dem Deutschlandticket innerhalb einer festgelegten Maximalreisedauer
