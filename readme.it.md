...
<h4 align="right">Visualizza in altre lingue</h4>
<p align="right"><a href="readme.md">🇬🇧</a> <a href="readme.de.md">🇩🇪</a> <a href="readme.fr.md">🇫🇷</a> <a href="readme.es.md">🇪🇸</a> <a href="readme.zh.md">🇹🇼</a> <a href="readme.ja.md">🇯🇵</a> <a href="readme.ko.md">🇰🇷</a> <a href="readme.hi.md">🇮🇳</a> <a href="readme.de-DE-BA.md">🏴󠁤󠁥󠁢󠁹󠁿</a></p>
...
- 👨‍💻 **Su di me**:
  - Artigiano del codice nel cuore 🤍
  - Fidanzato 💍
  - Ateo ⚛️
  - Astemio 🍻

- 🔭 Attualmente lavoro presso [Fourenergy como consulente IT](https://www.fourenergy.de/)
- 🧑‍💼 **Lavoro volontario**:
  - 🧭 [Vicepresidente Jusos Coburg](https://www.instagram.com/jusos_coburg/)
...
### 🖼️ API per immagini casuali ([Visualizza repository](https://github.com/OpenFoxes/random-image-api))

> API in grado di selezionare e fornire immagini casuali in base a determinati criteri.

#### NUEVO!
Un piccolo script Python che avevo scritto tempo fa per un progetto privato. L’API può essere utile in diversi casi d’uso, quindi l’ho caricata su GitHub. La aggiornerò di tanto in tanto con nuove funzioni e correzioni di bug.

### 🎦 Tiny4Linux ([Visualizza repository](https://github.com/OpenFoxes/Tiny4Linux))

> Controller GUI per gestire la serie OBSBOT Tiny su sistemi Linux
...
|📦 Progetti|🎉 Stato|✔️ Stato della build|🛎 Issues|📬 Pull request|
|------|------|------|------|------|
...
|[Notfallapp](https://github.com/Hirschfuchs/Notfallapp) ([Mostra online](https://notrufe.app/))|📃 Pianificato|<img alt="State" src="https://img.shields.io/website?down_color=red&down_message=offline&up_color=blue&up_message=online&url=https://notrufe.app/"/> <img alt="Security (Headers)" src="https://img.shields.io/mozilla-observatory/grade/notrufe.app?label=h-security&logo=mozilla&publish"/>|<img alt="Issues" src="https://img.shields.io/github/issues/Hirschfuchs/Notfallapp?style=flat-square"/>|<img alt="Pull Requests" src="https://img.shields.io/github/issues-pr/Hirschfuchs/Notfallapp?style=flat-square"/>|
|[Pianificatore Deutschlandticket](https://github.com/OpenFoxes/deutschlandticket-planner-backend)|📃 Pianificato|<img alt="State" src="https://img.shields.io/badge/website-Ancora%20nessun%20sito%20web-orange" />|<img alt="Issues" src="https://img.shields.io/github/issues/OpenFoxes/deutschlandticket-planner-backend?style=flat-square"/>|<img alt="Pull Requests" src="https://img.shields.io/github/issues-pr/OpenFoxes/deutschlandticket-planner-backend?style=flat-square"/>|
|[Generatore di changelog con Gitmoji](https://github.com/OpenFoxes/generate-changelog-gitmoji)|📃 Pianificato|<img alt="State" src="https://img.shields.io/badge/website-Ancora%20nessun%20sito%20web-orange" />|<img alt="Issues" src="https://img.shields.io/github/issues/OpenFoxes/generate-changelog-gitmoji?style=flat-square"/>|<img alt="Pull Requests" src="https://img.shields.io/github/issues-pr/OpenFoxes/generate-changelog-gitmoji?style=flat-square"/>|
|[Wikipedia Poker](https://github.com/OpenFoxes/wikipedia-poker)|📃 Pianificato|<img alt="State" src="https://img.shields.io/badge/website-Ancora%20nessun%20sito%20web-orange" />|<img alt="Issues" src="https://img.shields.io/github/issues/OpenFoxes/wikipedia-poker?style=flat-square"/>|<img alt="Pull Requests" src="https://img.shields.io/github/issues-pr/OpenFoxes/wikipedia-poker?style=flat-square"/>|
|[Panoramica Stolpersteine Ilmenau](https://github.com/Hirschfuchs/stolpersteine-ilmenau.de) ([Mostra online](https://stolpersteine-ilmenau.de))|📃 Pianificato|<img alt="State" src="https://img.shields.io/website?down_color=red&down_message=offline&up_color=blue&up_message=online&url=https://stolpersteine-ilmenau.de"/> <img alt="Security (Headers)" src="https://img.shields.io/mozilla-observatory/grade/stolpersteine-ilmenau.de?label=h-security&logo=mozilla&publish"/>|<img alt="Issues" src="https://img.shields.io/github/issues/Hirschfuchs/stolpersteine-ilmenau.de?style=flat-square"/>|<img alt="Pull Requests" src="https://img.shields.io/github/issues-pr/Hirschfuchs/stolpersteine-ilmenau.de?style=flat-square"/>|
|GameFrame ([Mostra online](https://game-frame.de))|💤 Inattivo|<img alt="State" src="https://img.shields.io/website?down_color=red&down_message=offline&up_color=blue&up_message=online&url=https://game-frame.de"/> <img alt="Security (Headers)" src="https://img.shields.io/mozilla-observatory/grade/game-frame.de?label=h-security&logo=mozilla&publish"/>|||

### 📖 Dettagli
- #️⃣ Set-Variable per Github Actions: Github Action per impostare variabili nel repository
- 🎦 Tiny4Linux: Controller GUI per gestire la serie OBSBOT Tiny su sistemi Linux
- 🎸 Kick-Pages: Siti web di un musicista locale. Alcuni errori tecnici dovuti alla mia inesperienza giovanile -> ricostruzione graduale.
- 🏠 Pagina iniziale di GitHub: Questa pagina (progetto per la generazione dinamica di un portfolio GitHub)
- 🔏 Raccolta di plugin KeePass: Raccolta personale di plugin KeePass utili, condivisa pubblicamente. Aggiornamenti automatici.
- 🖼️ API per immagini casuali: API in grado di selezionare e fornire immagini casuali in base a determinati criteri.
- 📖 Portfolio: Auto-promozione ^^
- ⌨️ Vim-Cheatsheet (Vimfo): Un cheatsheet interattivo per i comandi di VIM
- 🏗️ TS-Builder: Implementazione di un pattern builder dinamico in Typescript
- 🚨 Notfallapp: Applicazione web per l'accesso rapido a numeri di emergenza e informazioni rilevanti
- 🚆 Pianificatore Deutschlandticket: Calcolo delle connessioni ferroviarie disponibili con il Deutschlandticket entro una durata massima di viaggio definita
- 🤓 Generatore di changelog con Gitmoji: Fork di un generatore di changelog, ma basato su Gitmoji invece che su parole chiave
- 👣 Wikipedia Poker: Un gioco in cui bisogna trovare il percorso più breve tra due articoli di Wikipedia (simile a six degrees of Wikipedia)
- 🕎 Panoramica Stolpersteine Ilmenau: Panoramica delle Stolpersteine a Ilmenau (progetto per commemorare le vittime dell'Olocausto)
- 🎲 GameFrame: Un simulatore di giochi da tavolo nel browser. Progetto universitario, attualmente non mantenuto né sviluppato ulteriormente. Inoltre, oltre 300 ticket JIRA correlati e tutte le risorse collegate sono stati eliminati. Meglio usare BoardGameArena, loro hanno realizzato la mia visione :)
## 📚 Argomenti

- 🌱 Attualmente sto imparando **Rust**
- 🌱 Attualmente sto imparando **VIM**
