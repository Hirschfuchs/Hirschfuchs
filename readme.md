...
<h4 align="right">View in other languages</h4>
<p align="right"><a href="readme.de.md">🇩🇪</a> <a href="readme.it.md">🇮🇹</a> <a href="readme.fr.md">🇫🇷</a> <a href="readme.es.md">🇪🇸</a> <a href="readme.zh.md">🇹🇼</a> <a href="readme.ja.md">🇯🇵</a> <a href="readme.ko.md">🇰🇷</a> <a href="readme.hi.md">🇮🇳</a> <a href="readme.de-DE-BA.md">🏴󠁤󠁥󠁢󠁹󠁿</a></p>
...
### 🎦 Tiny4Linux ([View Repo](https://github.com/OpenFoxes/Tiny4Linux))

> GUI controller for managing the OBSBOT Tiny series on Linux systems

#### NEW!
When choosing a new webcam, I went with the Tiny 2 Lite from OBSBOT. This PTZ camera has some fancy features — but unfortunately, I couldn’t control it on Linux. Luckily, there are a few projects that bring tracking control to Linux. However, since I also needed other functions like Sleep & Wake or preset retrieval, I forked one of those projects and continued developing it.
...
- 🎲 GameFrame: A tabletop boardgame simulation in the webbrowser. University-Project, currently not maintained or further developed. Additionally over 300 corresponding JIRA-tickets and all linked resources got deleted. Just use BoardGameArena instead, they implemented my vision :)
## 📚 Topics
